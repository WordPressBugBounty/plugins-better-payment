                                ...
                                <div class="dynamic-amount-section-inner has-text-white p-6">
                                    <div class="pt-3 pb-3">
                                        <h4 class="is-size-2-fix bp-dynamic-amount-section-amount-summary">
                                            <?php
                                            printf(
                                                wp_kses( __( '%1$s<span class="bp-transaction-details-amount-text">%2$s</span>%3$s', 'better-payment' ), $valid_html_tags ),
                                                wp_kses( $layout_form_currency_left, $valid_html_tags ),
                                                '' !== $product_price ? floatval( $product_price ) : esc_html( $render_attribute_default_text ),
                                        ...
                                        <p class="is-size-6-fix pt-2 bp-dynamic-amount-section-amount">
                                            <?php if ( $is_payment_type_woocommerce || $is_payment_type_fluentcart ) : ?>
                                                <?php printf( wp_kses( __( '%1$s <a class="has-text-white" href="%2$s">%3$s</a>', 'better-payment' ), $valid_html_tags ), esc_html( $layout_form_transaction_details_product_title ), esc_url( $product_permalink ), esc_html( $product_name ) ); ?><br>
                                            <?php endif; ?>
