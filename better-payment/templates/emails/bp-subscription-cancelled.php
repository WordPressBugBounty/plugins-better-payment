<?php
/**
 * Customer "subscription cancelled" email (HTML).
 *
 * Override by copying it to yourtheme/better-payment/emails/bp-subscription-cancelled.php.
 *
...
<p>
    ...
    printf(
        ...
        esc_html__( 'Your subscription (order %1$s) on %2$s has been cancelled. No further renewal payments will be charged.', 'better-payment' ),
